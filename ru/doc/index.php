...
<div id="block">
	...
	<div id="block_info">
		...
		<p>Официальная документация SliTaz доступна на сайте Wiki сообщества. Каждый LiveCD SliTaz комплектуется инструкциями и руководством по началу работы, которые доступны через меню «Документация».</p>
...
<p><a href="http://doc.slitaz.org/ru:cookbook:start">Cookbook</a> — Поваренная книга SliTaz. Информация, касающаяся управления, функционирования и развития дистрибутива. Инструкции по использованию wok и рецептов пакетов, описания загрузочных сценариев и файлов rootcd, а также различных утилит.</p>
...
<ul>
	<li><a href="http://hg.slitaz.org/tazpkg/raw-file/tip/doc/tazpkg.en.html">Руководство Tazpkg <em>(англ.)</em></a> — Менеджер пакетов SliTaz.</li>
	<li><a href="http://hg.slitaz.org/tazlito/raw-file/tip/doc/tazlito.en.html">Руководство Tazlito <em>(англ.)</em></a> — Утилита LiveCD SliTaz.</li>
	<li><a href="http://hg.slitaz.org/tazusb/raw-file/tip/doc/tazusb.en.html">Руководство TazUSB <em>(англ.)</em></a> — Утилита LiveUSB SliTaz.</li>
	<li><a href="http://hg.slitaz.org/cookutils/raw-file/tip/doc/cookutils.en.html">Руководство Cookutils <em>(англ.)</em></a> — Сборщик пакетов SliTaz.</li>
</ul>


<h2>Примечания к выпуску</h2>

<p>Примечания к выпускам SliTaz предоставляют подробную информацию о стабильной версии и дают несколько полезных советов, которые помогут вам начать работать с системой. Примечания к выпускам включены в основной LiveCD и доступны через меню «Документация».</p>

<ul>
	<li><a href="/en/doc/releases/3.0/relnotes.en.html">SliTaz GNU/Linux 3.0 — Release Notes</a></li>
	<li><a href="/en/doc/releases/2.0/relnotes.en.html">SliTaz GNU/Linux 2.0 — Release Notes</a></li>
	<li><a href="/en/doc/releases/1.0/relnotes.en.html">SliTaz GNU/Linux 1.0 — Release Notes</a></li>
</ul>
