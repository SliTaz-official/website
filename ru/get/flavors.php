...
<div id="block">
	...
	<!-- Information/image -->
	<div id="block_info">
		<h4>Загрузка редакций</h4>
		<p>Система редакций LiveCD — это простой способ для сообщества создавать ISO-образы для выполнения определенных задач, предлагая выбор конкретных пакетов. Вы можете использовать редакции, сделанные сообществом или создать свою собственную с помощью простого в использовании графического интерфейса.</p>
	</div>
</div>
