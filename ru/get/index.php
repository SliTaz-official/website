...
<div id="block">
	...
	<div id="block_info">
		...
		<p>Загрузите последнюю стабильную версию для производственных целей, или, когда вам нужно надежное рабочее место. Тестируйте «готовящуюся» версию, чтобы помочь нам улучшить дистрибутив.</p>
...
<ul>
	<li><a href="index.php#stable">LiveCD стабильная версия</a> — загрузочный образ ISO текущей стабильной версии.</li>
	<li><a href="index.php#cooking">LiveCD версия Cooking</a> — загрузочный образ ISO нестабильной («готовящейся») версии.</li>
	<li><a href="index.php#floppy">Дискета</a> — загрузочная дискета для запуска LiveCD, флешки и т.п.</li>
	<li><a href="flavors.php">LiveCD на любой вкус</a> — Flavors и loram.</li>
</ul>

<div class="box">
	<p>Помогите проекту своим небольшим пожертвованием или станьте нашим официальным <a href="../sponsor/">спонсором</a>.</p>
...
<p>В этом разделе сайта вы можете загрузить бесплатную копию LiveCD SliTaz GNU/Linux и получить исходники утилит. Чтобы начать использовать ISO-образ LiveCD, вы можете обратиться к онлайн-<a href="../doc/">документации</a>. Вы можете также найти помощь и поддержку на <a href="http://forum.slitaz.org/">форуме</a> SliTaz.</p>


<h3>Зеркала</h3>

<p>SliTaz зеркалируется во Франции компаниями <a href="http://www.ads-lu.com/">ADS</a> и <a href="http://www.tuxfamily.org/">TuxFamily</a>, в Швейцарии — <a href="http://mirror.switch.ch/">SWITCHmirror</a>, в Китае — LupaWorld, в США — <a href="http://distro.ibiblio.org/pub/linux/distributions/">Ibiblio</a> и в Бразилии — <a href="http://www.c3sl.ufpr.br/en/index.html">UFPR</a>. Большое им спасибо!</p>
...
<ul>
	...
	<a href="http://distro.ibiblio.org/pub/linux/distributions/slitaz/">HTTP</a> или
...
<p>Tazpkg (менеджер пакетов), Tazlito (Live-утилита), Tazwok (Source builder), Tazusb (LiveUSB-утилита) и архивы всех утилит SliTaz можно загрузить с зеркала <a href="http://www.tuxfamily.org/">TuxFamily</a>. Обратите внимание, что все эти утилиты по умолчанию установлены в SliTaz, а исходники прокомментированы на английском. Загрузите исходники: [ <a href="http://mirror.slitaz.org/sources/">HTTP</a> или <a href="http://mirror.slitaz.org/sources/">FTP</a> ]</p>


<h2 id="stable">LiveCD — стабильная версия</h2>

<p>SliTaz стабильной версии — это зрелая операционная система, основательно протестированная активным сообществом. Основной LiveCD предоставляет широкий выбор многофункциональных пакетов, тщательно интегрированных в дистрибутив, в результате чего получилась самодостаточная и надежная система.
	<?php echo "Текущая стабильная версия $stable_ver была выпущена $stable_rel."; ?>
</p>
...
<p>Загрузочный образ компакт-диска со всеми доступными пакетами стабильной версии создается каждый день. Он также содержит копию сайта и может быть использован при помощи скрипта install.sh без подключения к Интернету.</p>
...
<p>LiveCD SliTaz версии «Cooking» — постоянно развивающаяся версия, полностью пригодная к использованию, что позволяет вам протестировать последние улучшения и пакеты, запрашивать новые функции или сообщать об ошибках, чтобы помочь нам подготовиться к стабильной версии.</p>
...
<p>Эта дискета может запустить SliTaz на старых компьютерах с CD-ROM или без него. Возможна также загрузка SliTaz с флешки, CD/DVD, жесткого диска, локальной сети по PXE, и даже через <a href="http://boot.slitaz.org/">интернет с помощью gPXE</a>.</p>
...
<p>Вы можете записать этот образ на дискету при помощи утилиты SliTaz, называющейся bootfloppybox, утилиты Windows <a href="http://en.wikipedia.org/wiki/RaWrite">rawrite</a>, или просто при помощи dd (<code>dd if=floppy-grub4dos of=/dev/fd0</code>).</p>

<p>Также доступен <a href="http://mirror.slitaz.org/floppies/">набор образов дискет</a> для тех, кто не может использовать CD-ROM, USB-флеш или карту Ethernet.</p>
