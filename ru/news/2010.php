...
<head>
	<meta charset="utf-8"/>
	<title>Архив новостей за 2010 год | SliTaz</title>
	<meta name="description" content="Архив новостей SliTaz за 2010 год"/>
...
<ul>
	...
	<li>
		...
		<p>The SliTaz team is organizing a 'Summer of Documentation' from May 10th to June 10th. The main aim is to centralize, review and update all online documentation. More details can be found at <a href="http://doc.slitaz.org/">doc.slitaz.org</a>. We hope that SliTaz users will be able to contribute by adding to or updating the documentation.</p>
	</li>
	...
	<li>
		...
		<p>The default core system fits into a 30 MB ISO image and LiveCD flavors start at 8 MB. This stable version has been built by a new toolchain including GCC 4.4.1 and uses the Linux kernel 2.6.30.6. You can read the full <a href="../../en/doc/releases/3.0/relnotes.en.html">Releases Notes</a> for more information and <a href="../get/#stable">download</a> a LiveCD image from the SliTaz mirrors.</p>
	</li>

	<li>
		<strong>14 March 2010 - RC series and Solutionslinux 2010 (Paris)</strong>
		<p>Since we're getting closer to the next stable release, we have updated the core ISO image to start with a RC series. The Major change is the switch to Midori as the default web browser, this will improve user experience and let us keep SliTaz at 30Mb. Midori is a modern browser powered by the webkit engine - it is fast, simple to use and well integrated with the SliTaz desktop.</p>
		<p>This updated ISO comes with a bunch of bug and dependency fixes, we have also improved the home made tools and scripts. This new ISO image can be downloaded from the SliTaz mirrors (30 Mb): <a href="http://mirror.slitaz.org/iso/cooking/slitaz-cooking.iso">slitaz-cooking.iso</a></p>
		<p>By the way, the SliTaz project will be at <a href="http://www.solutionslinux.fr/">Solutionslinux</a> 2010 next week in Paris. You will be able to learn about the project and make contact with members of the association and the development team.</p>
	</li>
