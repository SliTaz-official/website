...
<table>
	<tbody>
		<tr>
			...
			<td>
				Allied Data Sys - ADS sponsors the main SliTaz mirror and offers
				us full access to a virtual machine with a high speed connection.
				This allows us to use the machine as we wish without any limitations.
				A huge thanks to ADS for the service and fast response to any
				questions and requests we might have.
			</td>
		</tr>
	</tbody>
</table>
